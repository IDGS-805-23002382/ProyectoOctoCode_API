    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentosProducto", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocumentosProducto_Productos_ProductoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostoUnitarioActual = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SolicitudesCotizacion_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoMerma = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    Restaurada = table.Column<bool>(type: "bit", nullable: false),
                    FechaRestauracion = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MermasMateriaPrima", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MermasMateriaPrima_AspNetUsers_UsuarioRegistroId",
                        column: x => x.UsuarioRegistroId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MermasMateriaPrima_MateriasPrimas_MateriaPrimaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecetasBOM", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecetasBOM_MateriasPrimas_MateriaPrimaId",
                        column: x => x.MateriaPrimaId,
                        principalTable: "MateriasPrimas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RecetasBOM_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComprasDetalle_MateriasPrimas_MateriaPrimaId",
                        column: x => x.MateriaPrimaId,
                        principalTable: "MateriasPrimas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Resenas_Ventas_VentaId",
                        column: x => x.VentaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CapasCosto_ComprasDetalle_CompraDetalleId",
                        column: x => x.CompraDetalleId,
                        principalTable: "ComprasDetalle",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CapasCosto_MateriasPrimas_MateriaPrimaId",
                        column: x => x.MateriaPrimaId,
                        principalTable: "MateriasPrimas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CapasCosto_CompraDetalleId",
                table: "CapasCosto",
                column: "CompraDetalleId");

            migrationBuilder.CreateIndex(
                name: "IX_CapasCosto_MateriaPrimaId",
                table: "CapasCosto",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComprasDetalle_MateriaPrimaId",
                table: "ComprasDetalle",
                column: "MateriaPrimaId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentosProducto_ProductoId",
                table: "DocumentosProducto",
                column: "ProductoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MermasMateriaPrima_MateriaPrimaId",
                table: "MermasMateriaPrima",
                column: "MateriaPrimaId");

            migrationBuilder.CreateIndex(
                name: "IX_MermasMateriaPrima_UsuarioRegistroId",
                table: "MermasMateriaPrima",
                column: "UsuarioRegistroId");

            migrationBuilder.CreateIndex(
                name: "IX_RecetasBOM_MateriaPrimaId",
                table: "RecetasBOM",
                column: "MateriaPrimaId");

            migrationBuilder.CreateIndex(
                name: "IX_RecetasBOM_ProductoId_MateriaPrimaId",
                table: "RecetasBOM",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resenas_VentaId",
                table: "Resenas",
                column: "VentaId");

            migrationBuilder.CreateIndex(
                name: "IX_SolicitudesCotizacion_ClienteId",
